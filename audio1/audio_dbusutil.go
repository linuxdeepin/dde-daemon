...
func (v *Audio) setPropAiNoiseSourcePath(value dbus.ObjectPath) (changed bool) {
	if v.AiNoiseSourcePath != value {
		v.AiNoiseSourcePath = value
		v.emitPropChangedAiNoiseSourcePath(value)
		return true
	}
	return false
}

func (v *Audio) emitPropChangedAiNoiseSourcePath(value dbus.ObjectPath) error {
	return v.service.EmitPropertyChanged(v, "AiNoiseSourcePath", value)
}
