...
// authorize checks the caller via polkit for the given action id.
// release/2500 has no security loader; plain polkit matches the other
// system-daemon methods on this branch (wallpaper.go, tty.go).
